...
public class Tarea2 {
    ...
    public static void main(String[] args) {
        ...
        //Ejercicio 3
        /*
        Persona humano1=new Persona(402520190, "SOL", 13.20, "Heredia");
        Persona humano2=new Persona(402520191, "PALCO", 10.30, "San José") ;
        Persona humano3=new Persona(402520192, "SOMBRA", 13.00, "Alajuela") ;
        Persona humano4=new Persona(402520193, "PALCO", 13.30, "Heredia") ;
